    ...
    switch ($choice) {
        '1' {
            ...
            if (-not (Test-Path -Path $localization1 -PathType Container)) {
                ...
                $liveLocalizationDir = Join-Path $localization1 "data\Localization\english\"
                ...
                $url = "https://raw.githubusercontent.com/drrakendu78/test/main/global.ini"
        ...
        '2' {
            ...
            if (-not (Test-Path -Path $localization2 -PathType Container)) {
                ...
                $ptuLocalizationDir = Join-Path $localization2 "data\Localization\english\"
        ...
        '3' {
            ...
            if (-not (Test-Path -Path $localization3 -PathType Container)) {
                ...
                $techpreviewLocalizationDir = Join-Path $localization3 "data\Localization\english\"
        ...
        '5' {
            ...
            Start-Process "https://traduction.circuspes.fr/fr/"
            Read-Host "Appuyez sur Entrée pour continuer..."
        }
        '6' {
            Clear-Host
