...
import { AlertTriangle, Code, Github, Heart, Shield, Sparkles } from "lucide-react";
    ...
    return (
        <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
                <Card className="group relative overflow-hidden rounded-2xl border border-amber-500/30 bg-[hsl(var(--background)/0.14)] shadow-[0_6px_16px_rgba(0,0,0,0.10)] backdrop-blur-md">
                    <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(120%_95%_at_100%_0%,rgba(245,158,11,0.12),transparent_58%)] opacity-60" />
                    ...
                    <CardContent className="relative space-y-3 pt-0">
                        <p className="text-sm leading-relaxed text-foreground/85">
                            Pas de certificat de code (~300 €/an pour un projet gratuit). Windows
                            SmartScreen et certains antivirus peuvent réagir, mais c'est attendu.
                        </p>
                        <div className="rounded-xl border border-amber-500/25 bg-amber-500/8 p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
                            <p className="mb-1.5 text-[11px] font-semibold uppercase tracking-wider text-amber-600 dark:text-amber-400">
                                Si SmartScreen apparaît
                            </p>
                            <ol className="space-y-0.5 text-xs text-amber-700/90 dark:text-amber-300/90">
                                <li>1. Clique « Informations complémentaires »</li>
                                <li>2. Puis « Exécuter quand même »</li>
                            </ol>
                        </div>
                    </CardContent>
                </Card>
