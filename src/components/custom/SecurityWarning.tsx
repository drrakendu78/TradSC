...
type SecurityState = { open: boolean; understood: boolean; neverShowAgain: boolean; shouldShow: boolean };

export function SecurityWarning({ onContinue }: SecurityWarningProps) {
    const [{ open, understood, neverShowAgain, shouldShow }, setState] = useState<SecurityState>({
        open: false, understood: false, neverShowAgain: false, shouldShow: false,
    });
    ...
    return (
        <Dialog open={open} onOpenChange={(v) => setState((s) => ({ ...s, open: v }))}>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start space-x-2">
                                    <Checkbox
                                        id="understood"
                                        checked={understood}
                                        onCheckedChange={(checked) => setState((s) => ({ ...s, understood: checked === true }))}
                                    />
                                ...
                                <div className="flex items-start space-x-2">
                                    <Checkbox
                                        ...
                                        onCheckedChange={(checked) => setState((s) => ({ ...s, neverShowAgain: checked === true }))}
                                    />
