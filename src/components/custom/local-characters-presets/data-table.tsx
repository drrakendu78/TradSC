                            ...
                            <TableRow className="hover:bg-transparent">
                                ...
                                >
                                    <div className="flex flex-col items-center gap-1">
                                        <div className="text-base text-muted-foreground">Aucun preset local pour le moment.</div>
                                        <div className="text-xs text-muted-foreground/70">Aucun personnage trouve</div>
                                    </div>
                                </TableCell>
                            </TableRow>
                        )}
