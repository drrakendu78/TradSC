    ...
    return (
        ...
        >
            <div className="absolute top-2 left-1/2 transform -translate-x-1/2 z-10 flex gap-1 opacity-80 hover:opacity-100 transition-opacity duration-300 bg-background/90 backdrop-blur-sm border border-border/50 shadow-sm rounded-md p-1">
                <Button variant="default" size="sm" onClick={handleOpenSpViewer} className="h-7 px-4 text-xs font-medium gap-1.5" title="Ouvrir SP Viewer en overlay">
                ...
                <Button variant="ghost" size="sm" onClick={handleOpenExternal} className="h-7 px-2" title="Ouvrir dans le navigateur">
