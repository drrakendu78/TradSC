...
export default function VerseGuide() {
    ...
    const handleOpenExternal = async () => {
        try {
            await openExternal("https://verseguide.com/");
        } catch {
            window.open("https://verseguide.com/", "_blank", "noopener,noreferrer");
        }
    };
        ...
        >
            ...
            <div className="flex items-center justify-between px-4 py-2 border-b border-border/50 bg-background/80 backdrop-blur-sm flex-shrink-0">
                ...
                <div className="flex gap-2">
                    ...
                    <Button variant="ghost" size="sm" onClick={() => invoke('open_overlay', { id: 'verseguide', url: 'https://verseguide.com/', x: 100.0, y: 100.0, width: 500.0, height: 700.0, opacity: 0.9 }).catch(console.error)} className="h-7 px-2 gap-1.5" title="Détacher en overlay">
            ...
            <div className="relative flex-1 min-h-0 overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-background/50 backdrop-blur-sm z-10">
                        <div className="flex flex-col items-center gap-4 p-6 bg-card rounded-lg border border-border shadow-lg max-w-md">
                            <p className="text-sm text-muted-foreground text-center">
                                Impossible de charger VerseGuide. Le site ne supporte peut-être pas l'intégration iframe.
                            </p>
                            <div className="flex gap-2">
                ...
                <iframe
                    ref={iframeRef}
                    src="https://verseguide.com/"
                    className="w-full h-full border-0"
                    title="VerseGuide - Guide Star Citizen"
                    allow="fullscreen"
                    onLoad={handleLoad}
                    onError={handleError}
                />
