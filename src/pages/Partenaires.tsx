...
const PARTNERS: Partner[] = [
    ...
    { id: "aetheris", name: "Ætheris", cat: "organisation", tag: "ORG · Mercenaires · Multi-gameplay · Fair-play", desc: "Corporation de mercenaires francophone. Ætheris pratique tous les styles de gameplay qu'offre Star Citizen dans un esprit fair-play : piraterie « noble » uniquement (pas de freekill), triche et streamhack proscrits, communication toujours privilégiée avant l'action. Une orga qui mise sur le jeu sain et le respect entre joueurs.", since: "2026-05-31", verified: true, hue: 265, link: "https://discord.gg/YQGADKFqMU", linkType: "discord", discordInvite: "https://discord.gg/YQGADKFqMU" },
    ...
    { id: "s-polytool", name: "SCCompanion", cat: "site", tag: "Traductions FR · Outils SC", desc: "Traductions FR de référence (recommandées dans StarTrad) et global.ini auto-syncés, utilisés comme source canonique pour les blueprints et les missions.", since: "2024-01-01", verified: true, hue: 310, link: "https://github.com/GerbyTV/PolyToolSC", linkType: "web", discordInvite: "https://discord.gg/WVAueFGvs6", featured: true },
    { id: "d-sccompanion", name: "SCCompanion", cat: "discord", tag: "Discord · Traductions FR", desc: "Le serveur Discord de SCCompanion (GerbyTV) — traductions FR de Star Citizen, blueprints et entraide communautaire.", since: "2024-01-01", verified: true, hue: 310, link: "https://discord.gg/WVAueFGvs6", linkType: "discord", discordInvite: "https://discord.gg/WVAueFGvs6" },
